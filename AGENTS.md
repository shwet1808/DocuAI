# my-ai-runtime — Coding Agent Instructions

A TypeScript AI orchestration runtime
...
- **Workflow Agent** — AI agent inside a runtime pipeline (Mastra)
...
| Mastra workflows, agents, step chains | `.agents/skills/mastra-workflow/SKILL.md` |
